  ...
  return {
    ...
    JsdocTypeFunction: (result, transform2) => {
      ...
      if (!result.arrow) {
        ...
        let stringified = `${result.typeParameters !== void 0 ? `<${(_i = result.typeParameters.map(transform2).join("," + ((_h = (_g = result.meta) == null ? void 0 : _g.typeParameterSpacing) != null ? _h : " "))) != null ? _i : ""}>` : ""}(${result.parameters.map(transform2).join("," + ((_k = (_j = result.meta) == null ? void 0 : _j.parameterSpacing) != null ? _k : " "))})${(_m = (_l = result.meta) == null ? void 0 : _l.preReturnMarkerSpacing) != null ? _m : " "}=>${(_o = (_n = result.meta) == null ? void 0 : _n.postReturnMarkerSpacing) != null ? _o : " "}${transform2(result.returnType)}`;
    ...
    JsdocTypeCallSignature: (result, transform2) => {
      ...
      return `${result.typeParameters !== void 0 ? `<${(_c = result.typeParameters.map(transform2).join("," + ((_b = (_a = result.meta) == null ? void 0 : _a.typeParameterSpacing) != null ? _b : " "))) != null ? _c : ""}>${(_e = (_d = result.meta) == null ? void 0 : _d.postGenericSpacing) != null ? _e : ""}` : ""}(${result.parameters.map(transform2).join("," + ((_g = (_f = result.meta) == null ? void 0 : _f.parameterSpacing) != null ? _g : " "))}): ${transform2(result.returnType)}`;
    },
    JsdocTypeConstructorSignature: (result, transform2) => {
      var _a, _b, _c, _d, _e, _f, _g, _h, _i;
      return `new${(_b = (_a = result.meta) == null ? void 0 : _a.postNewSpacing) != null ? _b : " "}${result.typeParameters !== void 0 ? `<${(_e = result.typeParameters.map(transform2).join("," + ((_d = (_c = result.meta) == null ? void 0 : _c.typeParameterSpacing) != null ? _d : " "))) != null ? _e : ""}>${(_g = (_f = result.meta) == null ? void 0 : _f.postGenericSpacing) != null ? _g : ""}` : ""}(${result.parameters.map(transform2).join("," + ((_i = (_h = result.meta) == null ? void 0 : _h.parameterSpacing) != null ? _i : " "))}): ${transform2(result.returnType)}`;
    },
    JsdocTypeMethodSignature: (result, transform2) => {
      var _a, _b, _c, _d, _e;
      const quote2 = result.meta.quote === "double" ? '"' : result.meta.quote === "single" ? "'" : "";
      return `${quote2}${result.name}${quote2}${(_a = result.meta.postMethodNameSpacing) != null ? _a : ""}${result.typeParameters !== void 0 ? `<${(_c = result.typeParameters.map(transform2).join("," + ((_b = result.meta.typeParameterSpacing) != null ? _b : " "))) != null ? _c : ""}>${(_d = result.meta.postGenericSpacing) != null ? _d : ""}` : ""}(${result.parameters.map(transform2).join("," + ((_e = result.meta.parameterSpacing) != null ? _e : " "))}): ${transform2(result.returnType)}`;
    },
    ...
    JsdocTypeComputedMethod: (result, transform2) => {
      var _a, _b, _c, _d, _e, _f, _g, _h, _i;
      if (result.value.type.startsWith("JsdocType")) {
        return `[${transform2(result.value)}]${result.optional ? "?" : ""}${result.typeParameters !== void 0 ? `<${(_c = result.typeParameters.map(transform2).join("," + ((_b = (_a = result.meta) == null ? void 0 : _a.typeParameterSpacing) != null ? _b : " "))) != null ? _c : ""}>${(_e = (_d = result.meta) == null ? void 0 : _d.postGenericSpacing) != null ? _e : ""}` : ""}(${result.parameters.map(transform2).join("," + ((_g = (_f = result.meta) == null ? void 0 : _f.parameterSpacing) != null ? _g : " "))}): ${transform2(result.returnType)}`;
      } else {
        if (computedPropertyStringifier === void 0) {
          throw new Error("Must have a computed property stringifier");
        }
        return `[${computedPropertyStringifier(result.value).replace(/;$/u, "")}](${result.parameters.map(transform2).join("," + ((_i = (_h = result.meta) == null ? void 0 : _h.parameterSpacing) != null ? _i : " "))}): ${transform2(result.returnType)}`;
      }
    }
  };
}
