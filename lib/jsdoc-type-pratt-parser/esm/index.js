...
// src/parslets/UniqueSymbolParslet.ts
var uniqueSymbolParslet = (parser, _precedence, left) => {
  if (left !== null) {
    return null;
  }
  if (parser.lexer.current.type !== "Identifier" || parser.lexer.current.text !== "unique" || parser.lexer.next.type !== "Identifier" || parser.lexer.next.text !== "symbol") {
    return null;
  }
