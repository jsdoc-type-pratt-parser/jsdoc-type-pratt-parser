...
var Parser = class {
  ...
  consume(types) {
    ...
    if (types.includes(this.lexer.current.type)) {
      if (this.range) {
        this.rangeStart += (_b = (_a = this.lexer.current) == null ? void 0 : _a.reduced) != null ? _b : 0;
      }
      if (this.loc) {
        this.locStart.line += (_d = (_c = this.lexer.current) == null ? void 0 : _c.line) != null ? _d : 0;
        this.locStart.column = ((_f = (_e = this.lexer.current) == null ? void 0 : _e.line) != null ? _f : 0) > 0 ? (_h = (_g = this.lexer.current) == null ? void 0 : _g.column) != null ? _h : 0 : this.locStart.column + ((_j = (_i = this.lexer.current) == null ? void 0 : _i.column) != null ? _j : 0);
      }
...
var Lexer = class _Lexer {
  ...
  static read(lexerRules, text, startOfLine = false) {
    ...
    const initialWhitespace = (_b = (_a = /^\s+/u.exec(text)) == null ? void 0 : _a[0]) != null ? _b : "";
    text = text.trimStart();
    ...
    for (const rule of lexerRules) {
      ...
      if (partial !== null) {
        ...
        const token = __spreadProps(__spreadValues({}, partial), {
          ...
          column: currentLines.length === 1 ? ((_d = (_c = initialLines.at(-1)) == null ? void 0 : _c.length) != null ? _d : 0) + ((_f = (_e = currentLines.at(-1)) == null ? void 0 : _e.length) != null ? _f : 0) : (_h = (_g = currentLines.at(-1)) == null ? void 0 : _g.length) != null ? _h : 0
        });
...
function stringifyRules({
  ...
  return {
    ...
    JsdocTypeObject: (result, transform2) => {
      ...
      const bracketSpacing = (_d = result.meta.bracketSpacing) != null ? _d : "";
      return `{${/* c8 ignore next -- Guard */
      (lbType && (separatorForSingleObjectField || result.elements.length > 1) ? "\n" + ((_e = result.meta.propertyIndent) != null ? _e : "") : bracketSpacing) + result.elements.map(transform2).join(
        result.meta.separator === "comma" ? ", " : lbType ? lbEnding + /* c8 ignore next -- Guard */
        ((_f = result.meta.propertyIndent) != null ? _f : "") : "; "
