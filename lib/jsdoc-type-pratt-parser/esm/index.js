  ...
  return {
    ...
    JsdocTypeFunction: (result, transform2) => {
      ...
      if (!result.arrow) {
        ...
        let stringified = `${result.typeParameters !== void 0 ? `<${(_c = result.typeParameters.map(transform2).join("," + ((_b = (_a = result.meta) == null ? void 0 : _a.typeParameterSpacing) != null ? _b : " "))) != null ? _c : ""}>` : ""}(${result.parameters.map(transform2).join(", ")}) => ${transform2(result.returnType)}`;
    ...
    JsdocTypeCallSignature: (result, transform2) => {
      var _a, _b, _c, _d, _e;
      return `${result.typeParameters !== void 0 ? `<${(_c = result.typeParameters.map(transform2).join("," + ((_b = (_a = result.meta) == null ? void 0 : _a.typeParameterSpacing) != null ? _b : " "))) != null ? _c : ""}>${(_e = (_d = result.meta) == null ? void 0 : _d.postGenericSpacing) != null ? _e : ""}` : ""}(${result.parameters.map(transform2).join(", ")}): ${transform2(result.returnType)}`;
    },
