(function (global, factory) {
    ...
    class Parser {
        constructor(grammar, lexer, baseParser, { module, strictMode, asyncFunctionBody, externalParsers } = {}) {
     ...
     * @param mode
     */
    function parse(expression, mode, { module = true, strictMode = true, asyncFunctionBody = true, computedPropertyParser } = {}) {
        let parser;
        switch (mode) {
            case 'closure':
     ...
     * @param modes
     */
    function tryParse(expression, modes = ['typescript', 'closure', 'jsdoc'], { module = true, strictMode = true, asyncFunctionBody = true } = {}) {
        let error;
