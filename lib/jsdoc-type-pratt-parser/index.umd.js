(function (global, factory) {
    ...
    class Parser {
        constructor(grammar, textOrLexer, baseParser, { externalParsers } = {}) {
    ...
    function parse(expression, mode, { computedPropertyParser } = {}) {
        switch (mode) {
            ...
            case 'typescript':
                return (new Parser(typescriptGrammar, expression, undefined, computedPropertyParser === undefined ? undefined : {
                    externalParsers: {
