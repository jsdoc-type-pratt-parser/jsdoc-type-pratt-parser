(function (global, factory) {
    ...
    class Lexer {
        ...
        static read(lexerRules, text, startOfLine = false) {
            ...
            const initialWhitespace = (_b = (_a = (/^\s+/u).exec(text)) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : '';
            text = text.trimStart();
            ...
            for (const rule of lexerRules) {
                ...
                if (partial !== null) {
                    ...
                    const token = Object.assign(Object.assign({}, partial), { startOfLine, reduced: trimmed + partial.text.length, line: initialLines.length + currentLines.length - 2, column: currentLines.length === 1
                            /* c8 ignore next 3 -- Defaults are for TS */
                            ? ((_d = (_c = initialLines.at(-1)) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0) +
                                ((_f = (_e = currentLines.at(-1)) === null || _e === void 0 ? void 0 : _e.length) !== null && _f !== void 0 ? _f : 0)
                            : ((_h = (_g = currentLines.at(-1)) === null || _g === void 0 ? void 0 : _g.length) !== null && _h !== void 0 ? _h : 0) });
    ...
    const objectSquaredPropertyParslet = composeParslet({
        ...
        parsePrefix: parser => {
            ...
            (innerBracketType === null || innerBracketType === void 0 ? void 0 : innerBracketType.type) === 'JsdocTypeObjectField' &&
            ...
            (innerBracketType === null || innerBracketType === void 0 ? void 0 : innerBracketType.type) === 'JsdocTypeName' &&
                parser.consume('in')) {
                const parentParser = parser.baseParser;
                parentParser.acceptLexerState(parser);
        ...
        return {
            ...
            JsdocTypeGeneric: (result, transform) => {
                ...
                if (result.meta.brackets === 'square') {
                    ...
                    return `${transform(result.left)}${result.meta.dot ? '.' : ''}<${result.elements.map(transform).join(',' + ((_a = result.meta.elementSpacing) !== null && _a !== void 0 ? _a : ' '))}>`;
                }
            },
            ...
            JsdocTypeObject: (result, transform) => {
                ...
                const bracketSpacing = (_d = result.meta.bracketSpacing) !== null && _d !== void 0 ? _d : '';
                return `{${
            /* c8 ignore next -- Guard */
            (lbType && (separatorForSingleObjectField || result.elements.length > 1) ? '\n' + ((_e = result.meta.propertyIndent) !== null && _e !== void 0 ? _e : '') : bracketSpacing) +
                result.elements.map(transform).join((result.meta.separator === 'comma' ? ', ' : lbType
                    ? lbEnding +
                        /* c8 ignore next -- Guard */
                        ((_f = result.meta.propertyIndent) !== null && _f !== void 0 ? _f : '')
                    : '; ')) +
