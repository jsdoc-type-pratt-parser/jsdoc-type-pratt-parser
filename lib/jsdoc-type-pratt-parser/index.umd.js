        ...
        return {
            ...
            JsdocTypeFunction: (result, transform) => {
                ...
                if (!result.arrow) {
                    ...
                    ? `<${(_j = result.typeParameters.map(transform).join(',' + ((_h = (_g = result.meta) === null || _g === void 0 ? void 0 : _g.typeParameterSpacing) !== null && _h !== void 0 ? _h : ' '))) !== null && _j !== void 0 ? _j : ''}>`
                    : ''}(${result.parameters.map(transform).join(',' + ((_l = (_k = result.meta) === null || _k === void 0 ? void 0 : _k.parameterSpacing) !== null && _l !== void 0 ? _l : ' '))})${(_o = (_m = result.meta) === null || _m === void 0 ? void 0 : _m.preReturnMarkerSpacing) !== null && _o !== void 0 ? _o : ' '}=>${(_q = (_p = result.meta) === null || _p === void 0 ? void 0 : _p.postReturnMarkerSpacing) !== null && _q !== void 0 ? _q : ' '}${transform(result.returnType)}`;
            ...
            JsdocTypeCallSignature: (result, transform) => {
                ...
                /* c8 ignore next -- Guard */
                ? `<${(_c = result.typeParameters.map(transform).join(',' + ((_b = (_a = result.meta) === null || _a === void 0 ? void 0 : _a.typeParameterSpacing) !== null && _b !== void 0 ? _b : ' '))) !== null && _c !== void 0 ? _c : ''}>${(_e = (_d = result.meta) === null || _d === void 0 ? void 0 : _d.postGenericSpacing) !== null && _e !== void 0 ? _e : ''}`
                : ''}(${result.parameters.map(transform).join(',' + ((_g = (_f = result.meta) === null || _f === void 0 ? void 0 : _f.parameterSpacing) !== null && _g !== void 0 ? _g : ' '))}): ${transform(result.returnType)}`;
            },
            JsdocTypeConstructorSignature: (result, transform) => {
                ...
                /* c8 ignore next -- Guard */
                ? `<${(_e = result.typeParameters.map(transform).join(',' + ((_d = (_c = result.meta) === null || _c === void 0 ? void 0 : _c.typeParameterSpacing) !== null && _d !== void 0 ? _d : ' '))) !== null && _e !== void 0 ? _e : ''}>${(_g = (_f = result.meta) === null || _f === void 0 ? void 0 : _f.postGenericSpacing) !== null && _g !== void 0 ? _g : ''}`
                : ''}(${result.parameters.map(transform).join(',' + ((_j = (_h = result.meta) === null || _h === void 0 ? void 0 : _h.parameterSpacing) !== null && _j !== void 0 ? _j : ' '))}): ${transform(result.returnType)}`;
            },
            JsdocTypeMethodSignature: (result, transform) => {
                ...
                /* c8 ignore next -- Guard */
                ? `<${(_c = result.typeParameters.map(transform).join(',' + ((_b = result.meta.typeParameterSpacing) !== null && _b !== void 0 ? _b : ' '))) !== null && _c !== void 0 ? _c : ''}>${(_d = result.meta.postGenericSpacing) !== null && _d !== void 0 ? _d : ''}`
                : ''}(${result.parameters.map(transform).join(',' + ((_e = result.meta.parameterSpacing) !== null && _e !== void 0 ? _e : ' '))}): ${transform(result.returnType)}`;
            },
        ...
        result.literals.slice(0, -1).map((literal, idx) => literal.replace(/`/gu, '\\`') + '${' + transform(result.interpolations[idx]) + '}').join('') + result.literals.slice(-1)[0].replace(/`/gu, '\\`')}\``),
            ...
            JsdocTypeComputedMethod: (result, transform) => {
                ...
                if (result.value.type.startsWith('JsdocType')) {
                    ...
                    return `[${computedPropertyStringifier(result.value).replace(/;$/u, '')}](${result.parameters.map(transform).join(',' + ((_j = (_h = result.meta) === null || _h === void 0 ? void 0 : _h.parameterSpacing) !== null && _j !== void 0 ? _j : ' '))}): ${transform(result.returnType)}`;
                }
            }
        };
    }
