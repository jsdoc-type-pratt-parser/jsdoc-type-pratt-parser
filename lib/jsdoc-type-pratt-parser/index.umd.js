(function (global, factory) {
    ...
    class Parser {
        constructor(grammar, textOrLexer, baseParser, { computedPropertyParser } = {}) {
        ...
        parsePrefix: parser => {
            ...
            if (innerBracketType !== undefined &&
                ...
                if (parser.computedPropertyParser !== undefined) {
                    ...
                    const remainingTextParser = new Parser(parser.grammar, remaining, parser.baseParser, {
    ...
    function createObjectParslet({ signatureGrammar, objectFieldGrammar, allowKeyTypes }) {
        return composeParslet({
            ...
            parsePrefix: parser => {
                ...
                if (!parser.consume('}')) {
                    let separator;
                    const fieldParser = new Parser(objectFieldGrammar, parser.lexer, parser, parser.computedPropertyParser !== undefined
                        ? { computedPropertyParser: parser.computedPropertyParser }
                        : undefined);
                    while (true) {
