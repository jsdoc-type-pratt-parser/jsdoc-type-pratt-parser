  ...
  return composeParslet({
    ...
    parsePrefix: (parser) => {
      ...
      if (!allowReservedWords) {
        ...
        if (module2 !== void 0 && module2 || strictMode !== void 0 && strictMode) {
        ...
        if (module2 !== void 0 && module2 || asyncFunctionBody !== void 0 && asyncFunctionBody) {
